...
using ExtendedKeyManagerViewModel = Branta.Features.Settings.ExtendedKey.ExtendedKeyManagerViewModel;
    ...
    public App()
    {
        _host = Host.CreateDefaultBuilder()
            ...
            .ConfigureServices(services =>
            {
                ...
                services.AddSingleton<ClipboardItemStore>();
                ...
                services.AddSingleton<WalletDashboardViewModel>();
                ...
                {
                    options.UseSqlite($"Data Source={Path.Join(FileStorage.GetBrantaDataPath("BrantaCore-v1.db"))}");
                });

                services.AddSingleton(s =>
                    new MainWindow(s.GetRequiredService<LanguageStore>(), s.GetRequiredService<ILogger<MainWindow>>())
                    {
